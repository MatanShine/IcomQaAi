...
SYSTEM_INSTRUCTION = {
    ...
    "behavior": {
        ...
        "source_references": {
            "rule": "If the context includes a source ID, include it in the answer.",
            "format": "Append at the end of the answer as 'Source ID: <id>'. Do not include URLs in the response."
        },
        "error_policy": {
